...
class Parser {
  ...
  readonly advanceOffset = (count: number, columns?: boolean) => {
    const currentLine = this.currentLine;
  ...
  readonly addChild = (tag: string, offset: number) => {
  ...
  readonly incorporateLine = (ln: string) => {
  ...
  readonly finalize = (block: MarkdownNode, lineNumber: number) => {
  ...
  readonly processInlines = (block: MarkdownNode) => {
