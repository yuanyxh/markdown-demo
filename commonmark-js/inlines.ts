...
class InlineParser {
  ...
  readonly parseBackticks = (block: MarkdownNode) => {
  ...
  // is a backslash.
  readonly parseBackslash = (block: MarkdownNode) => {
  ...
  readonly parseAutolink = (block: MarkdownNode) => {
    let m: string | null;
    let dest: string;
    let node: MarkdownNode;
  ...
  readonly parseHtmlTag = (block: MarkdownNode) => {
  ...
  readonly handleDelim = (cc: number, block: MarkdownNode) => {
  ...
  readonly parseOpenBracket = (block: MarkdownNode) => {
    const startpos = this.pos;
  ...
  readonly parseBang = (block: MarkdownNode) => {
    const startpos = this.pos;
  ...
  readonly parseCloseBracket = (block: MarkdownNode) => {
    let startpos: number;
  ...
  readonly addBracket = (node: MarkdownNode, index: number, image: boolean) => {
  ...
  readonly parseEntity = (block: MarkdownNode) => {
    let m: string | null;
  ...
  readonly parseString = (block: MarkdownNode) => {
    let m: string | null;
  ...
  readonly parseNewline = (block: MarkdownNode) => {
  ...
  readonly parseReference = (s: string, refmap: ILinkRefMap) => {
    this.subject = s;
    this.pos = 0;
  ...
  readonly parseInline = (block: MarkdownNode) => {
    let res = false;
  ...
  readonly processEmphasis = (stack_bottom: IInlineParserDelimiter | null) => {
  ...
  readonly removeDelimiter = (delim: IInlineParserDelimiter) => {
  ...
  readonly parse = (block: MarkdownNode) => {
