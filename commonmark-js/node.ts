...
export class NodeWalker {
  ...
  readonly resumeAt = (node: MarkdownNode, entering: boolean) => {
    this.current = node;
...
class MarkdownNode {
  ...
  readonly appendChild = (child: MarkdownNode) => {
    child.unlink();
    child._parent = this;
  ...
  readonly prependChild = (child: MarkdownNode) => {
    child.unlink();
    child._parent = this;
  ...
  readonly insertAfter = (sibling: MarkdownNode) => {
    sibling.unlink();
  ...
  readonly insertBefore = (sibling: MarkdownNode) => {
    sibling.unlink();
