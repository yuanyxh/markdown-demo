...
class Escaping {
  static readonly ESCAPABLE: string = '[!"#$%&\'()*+,./:;<=>?@\\[\\\\\\]^_`{|}~-]';

  static readonly ENTITY: string = '&(?:#x[a-f0-9]{1,6}|#[0-9]{1,7}|[a-z][a-z0-9]{1,31});';
  ...
  private static readonly ESCAPE_IN_URI = /(%[a-fA-F0-9]{0,2}|[^:/?#@!$&'()*+,;=a-zA-Z0-9\-._~])/;
