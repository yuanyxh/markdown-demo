...
this.block.setLiteral(literal);
    ...
    public static Factory =  class Factory extends AbstractBlockParserFactory {
        ...
        public  tryStart(state: ParserState| null, matchedBlockParser: MatchedBlockParser| null):  BlockStart | null {
            ...
            if (ThematicBreakParser.isThematicBreak(line, nextNonSpace)) {
                let  literal  = java.lang.String.valueOf(line.subSequence(state.getIndex(), line.length()));
    ...
    private static  isThematicBreak(line: java.lang.CharSequence| null, index: int):  boolean {
        let  dashes: int = 0;
