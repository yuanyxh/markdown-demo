...
export  class InlineParserContextImpl extends JavaObject implements InlineParserContext {
    ...
    public  constructor(inlineContentParserFactories: java.util.List<InlineContentParserFactory>| null,
...
this.inlineContentParserFactories = inlineContentParserFactories;
    ...
    public  getLinkReferenceDefinition(label: java.lang.String| null):  LinkReferenceDefinition | null {
        return this.definitions.getDefinition(LinkReferenceDefinition.class, label);
    }

    public  getDefinition <D>(type: java.lang.Class<D>| null, label: java.lang.String| null):  D | null {
