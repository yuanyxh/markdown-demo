 ...
 */
export class HtmlInlineParser
  extends JavaObject
  implements InlineContentParser
{
  private static readonly asciiLetter: AsciiMatcher | null =
  ...
  private static readonly tagNameStart: AsciiMatcher | null =
    HtmlInlineParser.asciiLetter;
  private static readonly tagNameContinue: AsciiMatcher | null =
    HtmlInlineParser.tagNameStart.newBuilder().range("0", "9").c("-").build();
  ...
  private static readonly attributeStart: AsciiMatcher | null =
    HtmlInlineParser.asciiLetter.newBuilder().c("_").c(":").build();
  private static readonly attributeContinue: AsciiMatcher | null =
  ...
  private static readonly attributeValueEnd: AsciiMatcher | null =
