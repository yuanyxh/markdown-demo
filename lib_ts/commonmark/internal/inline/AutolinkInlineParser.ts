 ...
 */
export  class AutolinkInlineParser extends JavaObject implements InlineContentParser {

    private static readonly  URI:  java.util.regex.Pattern | null = java.util.regex.Pattern
            .compile("^[a-zA-Z][a-zA-Z0-9.+-]{1,31}:[^<>\u0000-\u0020]*$");

    private static readonly  EMAIL:  java.util.regex.Pattern | null = java.util.regex.Pattern
    ...
    public  tryParse(inlineParserState: InlineParserState| null):  ParsedInline | null {
        ...
        if (scanner.find('>') > 0) {
            ...
            let  content: java.lang.String = textSource.getContent();
            scanner.next();

            let  destination: java.lang.String = null;
