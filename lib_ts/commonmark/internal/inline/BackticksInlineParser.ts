 ...
 */
export  class BackticksInlineParser extends JavaObject implements InlineContentParser {
    ...
    public  tryParse(inlineParserState: InlineParserState| null):  ParsedInline | null {
        ...
        while (scanner.find('`') > 0) {
            ...
            if (count === openingTicks) {
                ...
                let  content: java.lang.String = scanner.getSource(afterOpening, beforeClosing).getContent();
