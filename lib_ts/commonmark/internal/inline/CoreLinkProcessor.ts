...
export  class CoreLinkProcessor extends JavaObject implements LinkProcessor {
    ...
    public  process(linkInfo: LinkInfo| null, scanner: java.util.Scanner| null, context: InlineParserContext| null):  LinkResult | null {
        if (linkInfo.destination() !== null) {
            // Inline link
            return this.process(linkInfo, scanner, linkInfo.destination(), linkInfo.title());
        }
        ...
        if (def !== null) {
            // Reference link
            return this.process(linkInfo, scanner, def.getDestination(), def.getTitle());
        }
        return LinkResult.none();
    }

    private static  process(linkInfo: LinkInfo| null, scanner: java.util.Scanner| null, destination: java.lang.String| null, title: java.lang.String| null):  LinkResult | null {
