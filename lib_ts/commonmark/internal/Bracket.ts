...
export  class Bracket extends JavaObject {
    ...
    public static  link(bracketNode: Text| null, bracketPosition: Position| null, contentPosition: Position| null, previous: Bracket| null, previousDelimiter: Delimiter| null):  Bracket | null {
        return new  Bracket(null, null, bracketNode, bracketPosition, contentPosition, previous, previousDelimiter);
    }

    public static  withMarker(markerNode: Text| null, markerPosition: Position| null, bracketNode: Text| null, bracketPosition: Position| null, contentPosition: Position| null, previous: Bracket| null, previousDelimiter: Delimiter| null):  Bracket | null {
        return new  Bracket(markerNode, markerPosition, bracketNode, bracketPosition, contentPosition, previous, previousDelimiter);
    }

    private  constructor(markerNode: Text| null, markerPosition: Position| null, bracketNode: Text| null, bracketPosition: Position| null, contentPosition: Position| null, previous: Bracket| null, previousDelimiter: Delimiter| null) {
        super();
