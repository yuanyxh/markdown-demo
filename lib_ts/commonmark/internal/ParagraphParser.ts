...
export  class ParagraphParser extends AbstractBlockParser {
    ...
    private readonly  linkReferenceDefinitionParser:  LinkReferenceDefinitionParser | null = new  LinkReferenceDefinitionParser();
    ...
    public  parseInlines(inlineParser: InlineParser| null):  void {
        let  lines: SourceLines = this.linkReferenceDefinitionParser.getParagraphLines();
        if (!lines.isEmpty()) {
