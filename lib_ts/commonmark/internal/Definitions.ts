...
export  class Definitions extends JavaObject {
    ...
    private readonly  definitionsByType:  java.util.Map<java.lang.Class<unknown>, DefinitionMap<unknown>> | null = new  java.util.HashMap();
    ...
    public  getDefinition <V>(type: java.lang.Class<V>| null, label: java.lang.String| null):  V | null {
