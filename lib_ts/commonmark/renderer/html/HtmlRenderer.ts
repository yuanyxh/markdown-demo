 ...
 * </code></pre>
 */
class HtmlRenderer extends JavaObject implements Renderer {
  ...
  private constructor(builder: HtmlRenderer.Builder | null) {
    ...
    this.attributeProviderFactories = new java.util.ArrayList(
      builder.attributeProviderFactories
    );

    this.nodeRendererFactories = new java.util.ArrayList(
      builder.nodeRendererFactories.size() + 1
    );
    this.nodeRendererFactories.addAll(builder.nodeRendererFactories);
    // Add as last. This means clients can override the rendering of core nodes if they want.
    this.nodeRendererFactories.add(
      new (class extends HtmlNodeRendererFactory {
        public create(
          context: HtmlNodeRendererContext | null
        ): NodeRenderer | null {
  ...
  public render(...args: unknown[]): java.lang.String | null | void {
    switch (args.length) {
      ...
      case 2: {
        ...
        java.util.Objects.requireNonNull(node, "node must not be null");
        let context: HtmlRenderer.RendererContext = new RendererContext(
          new HtmlWriter(output)
        );
  ...
  public static Builder = class Builder extends JavaObject {
    ...
    private attributeProviderFactories: java.util.List<AttributeProviderFactory> | null =
      new java.util.ArrayList();
    private nodeRendererFactories: java.util.List<HtmlNodeRendererFactory> | null =
      new java.util.ArrayList();
    ...
    public attributeProviderFactory(
      attributeProviderFactory: AttributeProviderFactory | null
    ): HtmlRenderer.Builder | null {
      java.util.Objects.requireNonNull(
        attributeProviderFactory,
        "attributeProviderFactory must not be null"
      );
    ...
    public nodeRendererFactory(
      nodeRendererFactory: HtmlNodeRendererFactory | null
    ): HtmlRenderer.Builder | null {
      java.util.Objects.requireNonNull(
        nodeRendererFactory,
        "nodeRendererFactory must not be null"
      );
     ...
     */
    public extensions(
      extensions: java.lang.Iterable<java.security.cert.Extension> | null
    ): HtmlRenderer.Builder | null {
      java.util.Objects.requireNonNull(
        extensions,
      ...
      for (let extension of extensions) {
        if (extension instanceof HtmlRendererExtension) {
          let htmlRendererExtension: Builder.HtmlRendererExtension =
            extension as HtmlRendererExtension;
  ...
  public RendererContext = (($outer) => {
      ...
      implements HtmlNodeRendererContext, AttributeProviderContext
    {
      ...
      private readonly nodeRendererMap: NodeRendererMap | null =
        new NodeRendererMap();
      ...
      private constructor(htmlWriter: HtmlWriter | null) {
        ...
        this.attributeProviders = new java.util.ArrayList(
          $outer.attributeProviderFactories.size()
        );
      ...
      private setCustomAttributes(
        node: Node | null,
        tagName: java.lang.String | null,
        attrs: java.util.Map<java.lang.String, java.lang.String> | null
      ): void {
