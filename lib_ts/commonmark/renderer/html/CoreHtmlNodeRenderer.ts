...
export  class CoreHtmlNodeRenderer extends AbstractVisitor implements NodeRenderer {
    ...
    protected readonly  context:  HtmlNodeRendererContext | null;
    private readonly  html:  HtmlWriter | null;

    public  constructor(context: HtmlNodeRendererContext| null) {
        super();
...
public visit(...args: unknown[]):  void {
        ...
        let  omitP: boolean = this.isInTightList(paragraph) || //
                (this.context.shouldOmitSingleParagraphP() && paragraph.getParent() instanceof Document && //
        ...
        let  attributes: java.util.Map<java.lang.String, java.lang.String> = new  java.util.LinkedHashMap();
        ...
        this.renderCodeBlock(indentedCodeBlock.getLiteral(), indentedCodeBlock, java.util.Map.of());
        ...
        let  attrs: java.util.Map<java.lang.String, java.lang.String> = new  java.util.LinkedHashMap();
        ...
        let  start: int = orderedList.getMarkerStartNumber() !== null ? orderedList.getMarkerStartNumber() : 1;
        let  attrs: java.util.Map<java.lang.String, java.lang.String> = new  java.util.LinkedHashMap();
        if (start !== 1) {
        ...
        let  altTextVisitor: CoreHtmlNodeRenderer.AltTextVisitor = new  CoreHtmlNodeRenderer.AltTextVisitor();
    ...
    private  renderCodeBlock(literal: java.lang.String| null, node: Node| null, attributes: java.util.Map<java.lang.String, java.lang.String>| null):  void {
        this.html.line();
    ...
    private  renderListBlock(listBlock: ListBlock| null, tagName: java.lang.String| null, attributes: java.util.Map<java.lang.String, java.lang.String>| null):  void {
        this.html.line();
    ...
    private  getAttrs(node: Node| null, tagName: java.lang.String| null):  java.util.Map<java.lang.String, java.lang.String> | null;

    private  getAttrs(node: Node| null, tagName: java.lang.String| null, defaultAttributes: java.util.Map<java.lang.String, java.lang.String>| null):  java.util.Map<java.lang.String, java.lang.String> | null;
private getAttrs(...args: unknown[]):  java.util.Map<java.lang.String, java.lang.String> | null {
		switch (args.length) {
			case 2: {
        ...
        return this.getAttrs(node, tagName, java.util.Map.of());
			...
			case 3: {
				const [node, tagName, defaultAttributes] = args as [Node, java.lang.String, java.util.Map<java.lang.String, java.lang.String>];
    ...
    public static AltTextVisitor =  class AltTextVisitor extends AbstractVisitor {
        ...
        private readonly  sb:  java.lang.StringBuilder | null = new  java.lang.StringBuilder();
...
export namespace CoreHtmlNodeRenderer {
	export type AltTextVisitor = InstanceType<typeof CoreHtmlNodeRenderer.AltTextVisitor>;
}
