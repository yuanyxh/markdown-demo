...
class BulletListHolder extends ListHolder {
  ...
  public constructor(parent: ListHolder, bulletList: BulletList) {
    ...
    this.marker =
      bulletList.getMarker() !== null ? bulletList.getMarker() : "-";
  }
}
  ...
  public visit(node: Node) {
    switch (true) {
      ...
      case node instanceof FencedCodeBlock: {
        ...
        const fenceChar =
          codeBlock.getFenceCharacter() !== null
            ? codeBlock.getFenceCharacter()
            : "`";
        ...
        const indent = codeBlock.getFenceIndent();
      ...
      case node instanceof ListItem: {
        ...
        const markerIndent =
          listItem.getMarkerIndent() !== null ? listItem.getMarkerIndent() : 0;
        ...
        const spaces =
          contentIndent !== null
            ? CoreMarkdownNodeRenderer.repeat(
                " ",
