 ...
 * @since 0.16.0
 */
export  class SourceSpans extends JavaObject {
    ...
    public  addAll(other: java.util.List<SourceSpan>| null):  void {
        ...
        if (this.sourceSpans.isEmpty()) {
            ...
            if (a.getInputIndex() + a.getLength() === b.getInputIndex()) {
                this.sourceSpans.set(lastIndex, SourceSpan.of(a.getLineIndex(), a.getColumnIndex(), a.getInputIndex(), a.getLength() + b.getLength()));
