 ...
 * @since 0.16.0
 */
export  class SourceSpan extends JavaObject {
     ...
     */
    public static  of(lineIndex: int, columnIndex: int, length: int):  SourceSpan | null;

    public static  of(line: int, col: int, input: int, length: int):  SourceSpan | null;
public static of(...args: unknown[]):  SourceSpan | null {
    ...
    private  constructor(lineIndex: int, columnIndex: int, inputIndex: int, length: int) {
        super();
if (lineIndex < 0) {
            throw new  java.lang.IllegalArgumentException("lineIndex " + lineIndex + " must be >= 0");
        }
        if (columnIndex < 0) {
            throw new  java.lang.IllegalArgumentException("columnIndex " + columnIndex + " must be >= 0");
        }
        if (inputIndex < 0) {
            throw new  java.lang.IllegalArgumentException("inputIndex " + inputIndex + " must be >= 0");
        }
        if (length < 0) {
            throw new  java.lang.IllegalArgumentException("length " + length + " must be >= 0");
        }
...
public subSpan(...args: unknown[]):  SourceSpan | null {
        ...
        if (beginIndex < 0) {
            throw new  java.lang.IndexOutOfBoundsException("beginIndex " + beginIndex + " + must be >= 0");
        }
        if (beginIndex > this.length) {
            throw new  java.lang.IndexOutOfBoundsException("beginIndex " + beginIndex + " must be <= length " + this.length);
        }
        if (endIndex < 0) {
            throw new  java.lang.IndexOutOfBoundsException("endIndex " + endIndex + " + must be >= 0");
        }
        if (endIndex > this.length) {
            throw new  java.lang.IndexOutOfBoundsException("endIndex " + endIndex + " must be <= length " + this.length);
        }
        if (beginIndex > endIndex) {
            throw new  java.lang.IndexOutOfBoundsException("beginIndex " + beginIndex + " must be <= endIndex " + endIndex);
        }
    ...
    public override  hashCode():  int {
        return java.util.Objects.hash(this.lineIndex, this.columnIndex, this.inputIndex, this.length);
    }
